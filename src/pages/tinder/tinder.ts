...
export class TinderPage {
  ...
  info = [
    ...
    {name: "Hong Kong Disneyland", content: "Hong Kong Disneyland is a theme park located on reclaimed land in Penny's Bay, Lantau Island. It is located inside the Hong Kong Disneyland Resort and it is owned and managed by Hong Kong International Theme Parks. It is the largest theme park in Hong Kong, followed by Ocean Park Hong Kong."},
    ...
    {name: "Ocean Park", content: "Ocean Park Hong Kong, commonly known as Ocean Park, is a marine mammal park, oceanarium, animal theme park and amusement park situated in Wong Chuk Hang and Nam Long Shan in the Southern District of Hong Kong. It is the second largest theme park in Hong Kong."},
    ...
    {name: "Victoria Peak", content: "Victoria Peak is a hill on the western half of Hong Kong Island. It is also known as Mount Austin."},
    {name: "", content: ""},
  ]
